...
Function Jenga
	...
	For i = 2 To 0 Step -1
		...
		Alignment_Block()
		Blocks = Blocks - 1
		Move origin +Z(Jengas * BlockHeight + TrayDistance) /1
		Move origin +Z(Jengas * BlockHeight) /1
		Off 8
		Wait PressureTime
		Jengas = Jengas + 1
		...
		Alignment_Token()
		Tokens = Tokens - 1
		Move origin +Z(Jengas * TokenHeight + TrayDistance) /1
		Move origin +Z(Jengas * TokenHeight) /1
		Off 8
		Wait PressureTime
		Jengas = Jengas + 1
	Next i
